...
const styles = StyleSheet.create({
  ...
  // Enhanced Structured Content Section Styles with Improved Spacing
  structuredSection: {
    marginHorizontal: 24,
    marginBottom: screenWidth > 768 ? 48 : 40,
    paddingTop: screenWidth > 768 ? 8 : 4,
  },
  ...
  viewAllButton: {
    ...
    alignItems: 'center',
    alignSelf: 'flex-end',
    paddingVertical: screenWidth > 768 ? 10 : 9,
    paddingHorizontal: screenWidth > 768 ? 16 : 14,
    borderRadius: 10,
    backgroundColor: 'rgba(74, 144, 226, 0.08)',
    marginTop: screenWidth > 768 ? 16 : 14,
    borderWidth: 1,
  ...
  // Letzte Kapitel (Chapter Cards) Styles with Enhanced Spacing
