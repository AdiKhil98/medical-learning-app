...
export default function FSPSimulationScreen() {
  ...
  useEffect(() => {
    ...
    if (timerActive) {
      console.log('🔄 FSP: Starting session activity tracker to prevent timeout');
      ...
      activityInterval = setInterval(async () => {
        console.log('⏰ FSP: Updating last activity to keep session alive');
    ...
    return () => {
      if (activityInterval) {
        console.log('🛑 FSP: Stopping session activity tracker');
