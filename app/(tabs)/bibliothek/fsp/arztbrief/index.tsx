...
export default function ArztbriefIndex() {
  ...
  const fetchTopics = useCallback(async () => {
    try {
      ...
      console.error('Error fetching Arztbrief topics:', error);
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const gruppeOrder = ['Grundlagen', 'Briefabschnitte', 'Formulierungshilfen', 'Musterarztbriefe'];
  ...
  const handleTopicPress = (slug: string) => {
    router.push(`/bibliothek/fsp/arztbrief/${slug}`);
  };
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Lade Arztbrief...</Text>
      </View>
    );
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>Arztbrief</Text>
          <Text style={styles.headerSubtitle}>{topics.length} Themen für die Dokumentation</Text>
        </View>
      </View>
      ...
      >
        {gruppeOrder.map((gruppe) => {
          ...
          const config = gruppeConfig[gruppe] || gruppeConfig['Grundlagen'];
