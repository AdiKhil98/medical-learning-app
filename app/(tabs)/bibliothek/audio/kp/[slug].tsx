...
export default function KPAudioPlayerScreen() {
  ...
  useEffect(() => {
    const fetchTopic = async () => {
      ...
      try {
        ...
        setTopic({ ...data, source_table: 'kp_medical_content' as const });
      } catch (err) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.lockedContainer}>
          ...
          <Text style={styles.lockedText}>Abonnieren Sie KP Audio, um diesen Inhalt anzuhören.</Text>
        </View>
        <AudioPaywallModal
          isOpen={paywallOpen}
          onClose={() => {
