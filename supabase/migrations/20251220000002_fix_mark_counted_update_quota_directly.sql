-- Migration: Fix mark_simulation_counted to update user_simulation_quota directly
-- Date: 2025-12-20
...
-- But the sync trigger to user_simulation_quota is broken
-- Result: counted_toward_usage=true but quota doesn't increment!
--
-- SOLUTION:
-- Update user_simulation_quota.simulations_used directly
-- Don't rely on sync trigger
-- ============================================
